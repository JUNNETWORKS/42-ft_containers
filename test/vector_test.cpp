...
//     const_stl_it = stl_vector.begin();
//     const_ft_it = ft_vector.begin();
//     for (; const_stl_it != stl_vector.end() && const_ft_it !=
//     ft_vector.end();
//          const_stl_it++, const_ft_it++) {
//     }
...
//         stl_vector.rbegin();
//     ft::vector<int>::const_reverse_iterator const_ft_rit =
//     ft_vector.rbegin(); ASSERT_EQ("*const_stl_rit == *const_ft_rit",
...
//     for (;
//          const_stl_rit != stl_vector.rend() && const_ft_rit !=
//          ft_vector.rend(); const_stl_rit++, const_ft_rit++) {
//     }

//     stl_rit = stl_vector.rbegin();
//     ft_rit = ft_vector.rbegin();
//     /* iterator allow write value at *it */
//     for (int i = 0; stl_rit != stl_vector.rend() && ft_rit !=
//     ft_vector.rend();
//          ++i, ++stl_rit, ++ft_rit) {
//       *stl_rit = i;
//       *ft_rit = i;
...
//     }
//     for (int i = 0; i < 3; ++i) {
//       ASSERT_EQ("stl_vector[i] == ft_vector[i]", stl_vector[i],
//       ft_vector[i]); ASSERT_EQ("stl_vector.at(i) == ft_vector.at(i)",
//       stl_vector.at(i),
//                 ft_vector.at(i));
//     }
